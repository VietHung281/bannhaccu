...
public class MomoApi {
    ...
    public ResponsePayment getUrlPayment(@RequestBody PaymentDto paymentDto){
        ...
        try {
            captureATMMoMoResponse = CreateOrderMoMo.process(environment, orderId, requestId, Long.toString(td), paymentDto.getContent(), paymentDto.getReturnUrl(), paymentDto.getNotifyUrl(), "", RequestType.CAPTURE_WALLET, null);
        } catch (Exception e) {
            e.printStackTrace();
        }
